 ...
 * 获取客户的详细信息
 */
@WebServlet(name="/GetDepartmentServlet",urlPatterns="/getDepartments.json")
public class GetDepartmentServlet extends BaseServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String json = null;
		try {
			json = CompanyDao.getInstance().getDepartments();
