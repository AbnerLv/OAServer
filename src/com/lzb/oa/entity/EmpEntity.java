...
public class EmpEntity {
	...
	private String emp_entry_date;   //员工入职日期
	private String emp_birthday;     //员工生日
	...
	public String getEmp_entry_date() {
		return emp_entry_date;
	}
	public void setEmp_entry_date(String emp_entry_date) {
	...
	public EmpEntity(String emp_nickname, String emp_name, String emp_sex,
			String emp_age, String emp_phone_no, String emp_email,
			String emp_no, String emp_department, String emp_position,
			String emp_entry_date, String emp_birthday, String emp_nation,
			String emp_identify, String emp_city, String emp_address) {
		this.emp_nickname = emp_nickname;
		this.emp_name = emp_name;
		this.emp_sex = emp_sex;
		this.emp_age = emp_age;
